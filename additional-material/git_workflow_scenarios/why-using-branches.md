...
vikrant is working on Feature A and Bob is working on Feature B. vikrant is halfway done with Feature A and has made a few commits in vikrant. However, Feature A is quite hard to implement so Alice decides that she should rather work on Feature C and makes a few commits onto vikrant. Bob finished Feature B and decides that he would like to tackle Feature A and so pulls aliceinto bob.
